...
void IG2App::setupScene(void){
    ...
    ent->setMaterialName("example/colorRojo");
    ...
    //std::cout << " holaaaaa paula es una tia muy listaaaaa" << std::endl;
...
//    nodeSpot2->attachObject(spotLight2);
    ...
    //directionalLight1->setDiffuseColour(1.0f,0.0f,0.0f);      // lava
    //directionalLight1->setDiffuseColour(0.0f, 1.0f, 0.0f);    // pota
    directionalLight1->setDiffuseColour(1.0f, 0.0f, 0.55f);     // morada
